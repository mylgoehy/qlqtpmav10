...
namespace UISample
{
	public partial class ListeningControl : UserControl
	{
        ...
        public ListeningControl()
		{
            ...
            bntVietnam.Visibility = Visibility.Collapsed;
		}
        ...
        {
            ListeningControl listeningControl = src as ListeningControl;

            if (src == null)
                return;

            listeningControl.LoadListeningContent();
        }

        private void LoadListeningContent()
        {
            if(SelectedUnit == 0)
                return;
            ...
            txbTitle.Text = "Unit " + SelectedUnit.ToString() + " Listening";
